        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 sm:p-10 z-10 relative">
          ...
          <form onSubmit={handleTrackSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">
                  Student Email ID <span className="text-brandBlue">*</span>
                </label>
                <input
                  type="email"
                  required
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-brandBlue focus:border-brandBlue focus:bg-white transition-all text-sm outline-none font-medium"
                />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">
                  Application Number <span className="text-brandBlue">*</span>
                </label>
                <input
                  type="text"
                  required
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3.5 bg-brandBlue hover:bg-brandDarkBlue text-white text-xs font-bold uppercase tracking-wider rounded-lg shadow-md transition-all ${
            ...
            <div className="text-center mt-6">
              <Link to="/postal-request" className="text-xs font-semibold text-gray-500 hover:text-brandBlue transition-colors">
